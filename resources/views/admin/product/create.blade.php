                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">                                
                                <div class="form-group">
                                    <label>Nombre</label>
                                        <input v-model="nombre" type="text" @blur="getProduct" @focus="myFocus" name="nombre" id="nombre" class="form-control">                                    
                                        
                                    <label for="slug">Slug</label>

                                    <div class="input-group">
                                        <input readonly v-model="generarSlug" type="text" name="slug" id="slug" v-bind:class="input_slug_class">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" v-text="div_slug_disponible" v-bind:style="{color:activeColor}"></span>
                                        </div>
                                    </div>
                                </div>   
                            </div>
