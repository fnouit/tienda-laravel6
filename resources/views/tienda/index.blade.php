                    ...
                    <div class="owl-carousel owl-theme home_slider">
                                                                    ...
                                                                    <div class="product_buttons">
                                                                        <div class="text-right d-flex flex-row align-items-start justify-content-start">
                                                                            <div class="product_button product_cart text-center d-flex flex-column align-items-center justify-content-center">
                                                                                <div>
                                                                                    <div><img src="{{asset('asset/images/cart_2.svg')}}" alt="">
                                                                                        <div>+</div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                        ...
                        <div class="owl-item">
                            <div class="background_image"
                                style="background-image:url({{asset('asset/images/product_1.jpg')}})"></div>
                            <div class="container fill_height">
                                <div class="row fill_height">
                                    <div class="col fill_height">
                                        <div
                                                        ...
                                                        <div class="col-lg-4 col-md-6 col-sm-8 offset-sm-2 offset-md-0">
                                                            <div class="product home_item_large">
                                                                ...
                                                                <div class="product_image"><img
                                                                        src="{{asset('asset/images/product_1.jpg')}}"
                                                                        alt=""></div>
                                                                <div class="product_content">
                        ...
                        <div class="owl-item">
                            <div class="background_image"
                                style="background-image:url({{asset('asset/images/product_2.jpg')}})"></div>
                            <div class="container fill_height">
                                <div class="row fill_height">
                                    <div class="col fill_height">
                                        <div
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4 col-md-6 col-sm-8 offset-sm-2 offset-md-0">
                                                            <div class="product home_item_large">
                                                                ...
                                                                <div class="product_image"><img
                                                                        src="{{asset('asset/images/product_2.jpg')}}"
                                                                        alt=""></div>
                                                                <div class="product_content">
                                                                    <div class="product_buttons">
                                                                        <div
                        ...
                        <div class="owl-item">
                            <div class="background_image"
                                style="background-image:url({{asset('asset/images/product_3.jpg')}})"></div>
                            <div class="container fill_height">
                                <div class="row fill_height">
                                    <div class="col fill_height">
                                        <div
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4 col-md-6 col-sm-8 offset-sm-2 offset-md-0">
                                                            <div class="product home_item_large">
                                                                ...
                                                                <div class="product_image"><img
                                                                        src="{{asset('asset/images/product_3.jpg')}}"
                                                                        alt=""></div>
                                                                <div class="product_content">
                                                                    <div class="product_buttons">
                                                                        <div
